...
<head>
    ...
    <title>Back Office | Ajouter à la catégorie</title>
...
<body class="bg-background_color text-dark_surface_text font-paragraphs">
    <main class="container mx-auto mt-4 px-4">
        ...
        <h1 class="text-4xl font-bold text-primary mb-6 mt-5">Ajouter à la catégorie</h1>
                ...
                <?php foreach ($recordset as $row) { ?>
                    <tr class="hover:bg-subtle_highlight">
                        ...
                        <td class="border-t px-4 py-2 text-center">
                            <a class="text-green-500 hover:text-green-700" href="add-process.php?category_id=<?= htmlspecialchars($_GET["id"]); ?>&group_id=<?= htmlspecialchars($row['group_id']) ?>" title="Ajouter à la catégorie">
