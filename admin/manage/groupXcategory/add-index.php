    ...
    <table class="table table-striped">
        ...
        <?php foreach ($recordset as $row) {?>
            <tr>
                ...
                <td><a style="text-decoration: none;" href="add-process.php?category_id=<?= $_GET["id"];?>&group_id=<?= $row['group_id']?>" title="Ajouter à la catégorie">➕</a></td>
            </tr>
        <?php }?>
    </table>
</body>
